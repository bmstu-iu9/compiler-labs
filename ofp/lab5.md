...
Результатом шага прогонки должен быть список пар ‹сужение, конфигурация›,
где сужение определяет налагаемое условие (оно может быть и тождественно
истинным), а конфигурация — дочернюю конфигурацию. В случае однозначного
перехода список содержит один элемент, а условие тождественно истинное.
